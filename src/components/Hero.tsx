...
import patternMountains from '@/assets/pattern-mountains.png';
      ...
      <div className="container mx-auto px-4 pt-24 pb-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-secondary-foreground leading-tight mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              El mejor café de las{' '}
              <span className="text-primary">montañas colombianas</span>
            </h1>
            
            <p className="text-secondary-foreground/80 text-lg md:text-xl max-w-xl mx-auto lg:mx-0 mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Notas de miel, canela y frutos amarillos. Desde las montañas del sur de Colombia 
            ...
            <div className="grid grid-cols-3 gap-6 mt-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="text-center">
                ...
                <div className="text-secondary-foreground/70 text-sm">Arábica</div>
              </div>
              <div className="text-center">
