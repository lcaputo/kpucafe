    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pt-20 pb-8 flex flex-col">
        <div className="container mx-auto px-4 max-w-4xl flex-1 flex flex-col">
          ...
          {/* Two-column grid */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-4 flex-1">

            {/* LEFT: Status + Tracking */}
            <div className="bg-card rounded-2xl p-5 shadow-sm flex flex-col gap-4 h-fit">
              <OrderStatusPoller
                orderId={order.id}
