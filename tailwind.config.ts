  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        kpu: {
          orange: "hsl(var(--kpu-orange))",
          "brown-dark": "hsl(var(--kpu-brown-dark))",
          "brown-medium": "hsl(var(--kpu-brown-medium))",
          "brown-light": "hsl(var(--kpu-brown-light))",
          cream: "hsl(var(--kpu-cream))",
          gold: "hsl(var(--kpu-gold))",
          tan: "hsl(var(--kpu-tan))",
        },
      },
      borderRadius: {
